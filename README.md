...
Este proyecto constituye el trabajo final del **Máster en Data & Analytics**. Consiste en el diseño, desarrollo y documentación de un flujo de **Análisis Exploratorio de Datos (EDA)** con el objetivo de realizar una analítica completa del ciclo de vida del cliente: desde la unificación y limpieza de fuentes, hasta el desarrollo de un EDA y la creación de un Dashboard operativo.

El análisis se centra en comprender el comportamiento de los clientes, optimizar la segmentación de valor y detectar factores críticos que influyen en la tasa de abandono o Churn, proporcionando recomendaciones estratégicas basadas en evidencia.
...
[Abrir 01_EDA_y_Limpieza.ipynb](./01_EDA_y_Limpieza.ipynb)
